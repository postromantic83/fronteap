...
var CrmComponent = /** @class */ (function () {
    function CrmComponent(crmService) {
    ...
    CrmComponent.prototype.stationList = function () {
        ...
        this.crmService.postfltGasStationsList(requestBody).subscribe(function (azsListResponse) {
    ...
    CrmComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_crm_service__WEBPACK_IMPORTED_MODULE_2__["CrmService"]])
    ], CrmComponent);
    return CrmComponent;
}());
